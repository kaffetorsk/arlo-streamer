...
MQTT_USERNAME: MQTT BROKER's username if your mqtt server is using non anonymous connection
MQTT_PASSWORD: MQTT BROKER's password
...
PYAARLO_STORAGE_DIR: Pyaarlo storage_dir. Define it if you want to change the Pyaarlo storage directory. 
```
### Running
```
python main.py
